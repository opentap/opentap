...
namespace OpenTap
{
    ...
    {
        public static TestPlanPreRunEventArgs Invoke(TestPlan plan, TestPlanRun planRun) => 
            Invoke(plan, (v, arg) => v.OnPreRun(arg), new TestPlanPreRunEventArgs(plan, planRun));
    }
