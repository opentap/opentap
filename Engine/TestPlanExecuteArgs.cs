...
/// <summary>
/// Arguments struct for TestPlan.Execute
/// </summary>
public sealed class TestPlanExecuteArgs
{
    ...
    public ISet<ITestStep> StepsOverride { get; set; }

    /// <summary> Callback for when something wants to pause the test plan execution.</summary>
    public Action<TestPlanPauseEventArgs> OnPauseRequestedCallback { get; set; }

    /// <summary>
    /// This cancellation token allows canceling the test plan execution.
    /// </summary>
