...
namespace OpenTap.Package
{
    ...
    public class PackageManagerSettings : ComponentSettings<PackageManagerSettings>
    {
        ...
        /// </summary>
        [Display("Check for Updates at Startup", Group: "General", Description: "Checks for updates against enabled package repositories. The update check sends anonymized package identifiers to the enabled repositories.")]
