...
namespace OpenTap.Package
{
    internal class JsonPackageSpecifierConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            CpuArchitecture architecture = jObject["Architecture"] == null ? CpuArchitecture.Unspecified : (CpuArchitecture)Enum.Parse(typeof(CpuArchitecture), jObject["Architecture"].Value<string>());
